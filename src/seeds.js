...
export function buildSeedTransactions() {
  return {
    '1': [
      // ── Month 0 (current month) — 18 transactions ──────────────────────
      { id: 'tx-001', descricao: 'Restaurante Sabor & Arte', valor: -45.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(2), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Restaurante Sabor & Arte', nsu: '123456', codigoAutorizacao: 'AUTH001', cnpjEstabelecimento: '12.345.678/0001-90', enderecoEstabelecimento: 'Av. Paulista, 1000 - SP', cartaoFinal: '4625', bandeira: 'Visa', mcc: '5812', mccDescricao: 'Restaurantes', parcelas: null, valorParcela: null, nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-002', descricao: 'Uber Trip — escritório', valor: -18.70, tipo: 'debito', categoria: 'Transporte', data: dDays(2), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Uber', nsu: '234567', codigoAutorizacao: 'AUTH002', cnpjEstabelecimento: '11.222.333/0001-44', enderecoEstabelecimento: 'App Uber', cartaoFinal: '9501', bandeira: 'Mastercard', mcc: '4121', mccDescricao: 'Transporte de passageiros', parcelas: null, valorParcela: null, nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-003', descricao: 'Compra pendente — Magazine Luiza', valor: -349.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(1), status: 'pendente', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Magazine Luiza' },
      { id: 'tx-004', descricao: 'Padaria Real — café da manhã', valor: -15.80, tipo: 'debito', categoria: 'Alimentação', data: dDays(3), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Padaria Real' },
      { id: 'tx-005', descricao: 'Drogaria Raia — medicamentos', valor: -64.50, tipo: 'debito', categoria: 'Saúde', data: dDays(3), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Drogaria Raia', nsu: '345678', codigoAutorizacao: 'AUTH003', cnpjEstabelecimento: '33.444.555/0001-66', enderecoEstabelecimento: 'R. Augusta, 723 — Consolação, SP', cartaoFinal: '2210', bandeira: 'Elo', mcc: '5912', mccDescricao: 'Farmácias', parcelas: null, valorParcela: null, nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-006', descricao: 'Livraria Cultura — livros técnicos', valor: -67.90, tipo: 'debito', categoria: 'Cultura', data: dDays(4), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Livraria Cultura' },
      { id: 'tx-007', descricao: 'iFood — Japa da Esquina', valor: -48.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(5), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'iFood' },
      { id: 'tx-008', descricao: 'Farmácia Drogasil — vitaminas', valor: -32.40, tipo: 'debito', categoria: 'Farmácia', data: dDays(5), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Drogasil' },
      { id: 'tx-009', descricao: 'QR Code — Padaria Luce', valor: -18.50, tipo: 'debito', categoria: 'Alimentação', data: dDays(6), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Padaria Luce' },
      { id: 'tx-010', descricao: '99 — Viagem trabalho', valor: -22.30, tipo: 'debito', categoria: 'Transporte', data: dDays(7), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: '99' },
      { id: 'tx-011', descricao: 'Restaurante Madero — almoço', valor: -95.00, tipo: 'debito', categoria: 'Alimentação', data: dDays(8), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Madero', nsu: '456789', codigoAutorizacao: 'AUTH004', cnpjEstabelecimento: '55.666.777/0001-88', enderecoEstabelecimento: 'Av. Paulista, 1811 — SP', cartaoFinal: '4625', bandeira: 'Visa', mcc: '5812', mccDescricao: 'Restaurantes', parcelas: null, valorParcela: null, nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-012', descricao: 'Shell — Combustível', valor: -180.00, tipo: 'debito', categoria: 'Combustível', data: dDays(9), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Posto Shell' },
      { id: 'tx-013', descricao: 'Pão de Açúcar — compras do mês', valor: -89.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(10), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Pão de Açúcar' },
      { id: 'tx-014', descricao: 'Crédito Refeição/Alimentação', valor: 600.00, tipo: 'credito', categoria: 'Crédito', data: dDays(1), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Origami' },
      { id: 'tx-015', descricao: 'Estorno — Drogasil cobrança duplicada', valor: 64.50, tipo: 'credito', categoria: 'Estorno', data: dDays(4), status: 'estornada', walletId: 'w6', walletTipo: 'saude', merchant: 'Drogasil' },
      { id: 'tx-016', descricao: 'Compra cancelada — Americanas', valor: -129.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(6), status: 'cancelada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Americanas' },
      { id: 'tx-017', descricao: 'PIX enviado — aluguel', valor: -1500.00, tipo: 'debito', categoria: 'Alimentação', data: dDays(3), status: 'aprovada', walletId: 'w8', walletTipo: 'flexivel', merchant: 'PIX' },
      { id: 'tx-018', descricao: 'Smart Fit — mensalidade mar', valor: -99.90, tipo: 'debito', categoria: 'Saúde', data: dDays(5), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Smart Fit' },

      // ── Month -1 (~30 days ago) — 14 transactions ──────────────────────
      { id: 'tx-019', descricao: 'Restaurante Fasano — almoço executivo', valor: -320.00, tipo: 'debito', categoria: 'Alimentação', data: dDays(32), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Fasano', nsu: '001234567890', codigoAutorizacao: 'AUTH-98765', cnpjEstabelecimento: '12.345.678/0001-90', enderecoEstabelecimento: 'Rua Haddock Lobo, 1738 — Jardim Paulista, SP', cartaoFinal: '4625', bandeira: 'Visa', mcc: '5812', mccDescricao: 'Restaurantes', parcelas: 1, valorParcela: 320.00, nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-020', descricao: 'Crédito Refeição Fev', valor: 600.00, tipo: 'credito', categoria: 'Crédito', data: dDays(30), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Origami' },
      { id: 'tx-021', descricao: 'Crédito Transporte Fev', valor: 400.00, tipo: 'credito', categoria: 'Crédito', data: dDays(30), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Origami' },
      { id: 'tx-022', descricao: 'Extra Supermercados', valor: -156.70, tipo: 'debito', categoria: 'Alimentação', data: dDays(33), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Extra' },
      { id: 'tx-023', descricao: 'Uber Trip', valor: -28.90, tipo: 'debito', categoria: 'Transporte', data: dDays(34), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Uber' },
      { id: 'tx-024', descricao: 'Bob\'s Burger — lanche', valor: -29.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(35), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Bob\'s' },
      { id: 'tx-025', descricao: 'Farmácia Pacheco', valor: -28.50, tipo: 'debito', categoria: 'Farmácia', data: dDays(36), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Pacheco' },
      { id: 'tx-026', descricao: 'Bilhete Único SPTrans', valor: -4.40, tipo: 'debito', categoria: 'Transporte', data: dDays(37), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'SPTrans' },
      { id: 'tx-027', descricao: 'Netflix — assinatura', valor: -55.90, tipo: 'debito', categoria: 'Cultura', data: dDays(38), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Netflix' },
      { id: 'tx-028', descricao: 'Rappi — Sushi San', valor: -62.50, tipo: 'debito', categoria: 'Alimentação', data: dDays(40), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Rappi' },
      { id: 'tx-029', descricao: 'Supermercado Dia', valor: -78.30, tipo: 'debito', categoria: 'Alimentação', data: dDays(42), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Dia' },
      { id: 'tx-030', descricao: 'Cinema Kinoplex — ingresso', valor: -35.00, tipo: 'debito', categoria: 'Cultura', data: dDays(44), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Kinoplex' },
      { id: 'tx-031', descricao: 'Compra pendente — Casas Bahia', valor: -459.00, tipo: 'debito', categoria: 'Educação', data: dDays(31), status: 'pendente', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Casas Bahia' },
      { id: 'tx-032', descricao: 'Carrefour — compras fev', valor: -234.50, tipo: 'debito', categoria: 'Alimentação', data: dDays(45), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Carrefour' },

      // ── Month -2 (~60 days ago) — 11 transactions ──────────────────────
      { id: 'tx-033', descricao: 'Crédito Refeição Jan', valor: 600.00, tipo: 'credito', categoria: 'Crédito', data: dDays(60), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Origami' },
      { id: 'tx-034', descricao: 'Crédito Flexível Jan', valor: 500.00, tipo: 'credito', categoria: 'Crédito', data: dDays(60), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Origami' },
      { id: 'tx-035', descricao: 'Crédito Cultura Jan', valor: 200.00, tipo: 'credito', categoria: 'Crédito', data: dDays(60), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Origami' },
      { id: 'tx-036', descricao: 'McDonald\'s — lanche', valor: -34.90, tipo: 'debito', categoria: 'Alimentação', data: dDays(62), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'McDonald\'s' },
      { id: 'tx-037', descricao: 'Shell — Combustível jan', valor: -195.00, tipo: 'debito', categoria: 'Combustível', data: dDays(65), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Posto Shell' },
      { id: 'tx-038', descricao: 'Amazon.com.br — parcela 1/3', valor: -43.30, tipo: 'debito', categoria: 'Cultura', data: dDays(67), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Amazon', parcelas: 3, valorParcela: 43.30, nsu: '567890', codigoAutorizacao: 'AUTH005', cnpjEstabelecimento: '15.436.940/0001-03', enderecoEstabelecimento: 'www.amazon.com.br', cartaoFinal: '9501', bandeira: 'Mastercard', mcc: '5942', mccDescricao: 'Livrarias', nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-039', descricao: 'Droga Raia — Vitaminas', valor: -45.90, tipo: 'debito', categoria: 'Farmácia', data: dDays(70), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Droga Raia' },
      { id: 'tx-040', descricao: 'Restaurante Coco Bambu', valor: -178.00, tipo: 'debito', categoria: 'Alimentação', data: dDays(72), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Coco Bambu' },
      { id: 'tx-041', descricao: 'Bilhete Único SPTrans', valor: -4.40, tipo: 'debito', categoria: 'Transporte', data: dDays(74), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'SPTrans' },
      { id: 'tx-042', descricao: 'Extra — compra jan', valor: -178.30, tipo: 'debito', categoria: 'Alimentação', data: dDays(76), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Extra' },
      { id: 'tx-043', descricao: 'Educação — Curso Alura', valor: -79.90, tipo: 'debito', categoria: 'Educação', data: dDays(78), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Alura' },

      // ── Month -3 (~90 days ago) — 9 transactions ───────────────────────
      { id: 'tx-044', descricao: 'Crédito Refeição Dez', valor: 600.00, tipo: 'credito', categoria: 'Crédito', data: dDays(90), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Origami' },
      { id: 'tx-045', descricao: 'Crédito Saúde Dez', valor: 500.00, tipo: 'credito', categoria: 'Crédito', data: dDays(90), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Origami' },
      { id: 'tx-046', descricao: 'Compra Dezembro — Natalina', valor: -456.00, tipo: 'debito', categoria: 'Alimentação', data: dDays(95), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Natalina' },
      { id: 'tx-047', descricao: 'Smart Fit — mensalidade dez', valor: -99.90, tipo: 'debito', categoria: 'Saúde', data: dDays(92), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Smart Fit' },
      { id: 'tx-048', descricao: 'Spotify Premium', valor: -21.90, tipo: 'debito', categoria: 'Cultura', data: dDays(98), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Spotify' },
      { id: 'tx-049', descricao: 'Padaria Luce — pão artesanal', valor: -12.50, tipo: 'debito', categoria: 'Alimentação', data: dDays(100), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Padaria Luce' },
      { id: 'tx-050', descricao: 'Uber Trip', valor: -14.50, tipo: 'debito', categoria: 'Transporte', data: dDays(102), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Uber' },
      { id: 'tx-051', descricao: 'Boleto — IPTU parcela 3', valor: -245.00, tipo: 'debito', categoria: 'Educação', data: dDays(105), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Prefeitura SP' },
      { id: 'tx-052', descricao: 'Recarga Vivo', valor: -30.00, tipo: 'debito', categoria: 'Transporte', data: dDays(108), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Vivo' },

      // ── Month -4 (~120 days ago) — 7 transactions ──────────────────────
      { id: 'tx-053', descricao: 'Crédito Transporte Nov', valor: 400.00, tipo: 'credito', categoria: 'Crédito', data: dDays(120), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Origami' },
      { id: 'tx-054', descricao: 'Home Office — Monitor Dell', valor: -890.00, tipo: 'debito', categoria: 'Home Office', data: dDays(122), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Dell', nsu: '678901', codigoAutorizacao: 'AUTH006', cnpjEstabelecimento: '72.381.189/0001-10', enderecoEstabelecimento: 'www.dell.com.br', cartaoFinal: '4625', bandeira: 'Visa', mcc: '5732', mccDescricao: 'Eletrônicos', parcelas: 3, valorParcela: 296.67, nomePortador: 'LUCAS O SILVA' },
      { id: 'tx-055', descricao: 'Saque bancário', valor: -200.00, tipo: 'debito', categoria: 'Transporte', data: dDays(125), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Banco do Brasil' },
      { id: 'tx-056', descricao: 'PIX Cash Out — banco', valor: -500.00, tipo: 'debito', categoria: 'Transporte', data: dDays(128), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'PIX Cash Out' },
      { id: 'tx-057', descricao: 'Atacadão — estoque mensal', valor: -312.40, tipo: 'debito', categoria: 'Alimentação', data: dDays(130), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Atacadão' },
      { id: 'tx-058', descricao: 'Netflix — assinatura nov', valor: -55.90, tipo: 'debito', categoria: 'Cultura', data: dDays(135), status: 'aprovada', walletId: 'w5', walletTipo: 'cultura', merchant: 'Netflix' },
      { id: 'tx-059', descricao: 'Estorno — Smart Fit cobrança duplicada', valor: 99.90, tipo: 'credito', categoria: 'Estorno', data: dDays(126), status: 'estornada', walletId: 'w6', walletTipo: 'saude', merchant: 'Smart Fit' },

      // ── Month -5 (~150 days ago) — 8 transactions ──────────────────────
      { id: 'tx-060', descricao: 'Crédito Refeição Out', valor: 600.00, tipo: 'credito', categoria: 'Crédito', data: dDays(150), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Origami' },
      { id: 'tx-061', descricao: 'Crédito Flexível Out', valor: 500.00, tipo: 'credito', categoria: 'Crédito', data: dDays(150), status: 'aprovada', walletId: 'w1', walletTipo: 'flexivel', merchant: 'Origami' },
      { id: 'tx-062', descricao: 'Restaurante Outback', valor: -145.00, tipo: 'debito', categoria: 'Alimentação', data: dDays(155), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Outback' },
      { id: 'tx-063', descricao: 'Posto Ipiranga — combustível', valor: -210.00, tipo: 'debito', categoria: 'Combustível', data: dDays(158), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Posto Ipiranga' },
      { id: 'tx-064', descricao: 'Consulta Oftalmologista', valor: -250.00, tipo: 'debito', categoria: 'Saúde', data: dDays(160), status: 'aprovada', walletId: 'w6', walletTipo: 'saude', merchant: 'Clínica Einstein' },
      ...
      { id: 'tx-069', descricao: 'Crédito Transporte Set', valor: 400.00, tipo: 'credito', categoria: 'Crédito', data: dDays(180), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Origami' },
      { id: 'tx-070', descricao: 'Café Starbucks', valor: -2.50, tipo: 'debito', categoria: 'Alimentação', data: dDays(182), status: 'aprovada', walletId: 'w3', walletTipo: 'refeicao', merchant: 'Starbucks' },
      { id: 'tx-071', descricao: 'Uber Black — aeroporto', valor: -85.00, tipo: 'debito', categoria: 'Transporte', data: dDays(184), status: 'aprovada', walletId: 'w4', walletTipo: 'transporte', merchant: 'Uber' },
...
export const SEED_PARTNERS = [
  // restaurante (3)
  { id: 'p1', name: 'IKD Restaurante', category: 'restaurante', address: 'Av. Paulista, 1578 — Bela Vista, SP', distance: '0.2 km', rating: 4.5, acceptedBenefits: ['refeicao'], discount: '10% no almoço', discountExpiresAt: dFuture(60), isOpen: true, lat: -23.564, lng: -46.651, description: 'Restaurante japonês com buffet por quilo no almoço.', phone: '(11) 3253-1578', hours: 'Seg–Sex 11h–15h, 18h–22h | Sáb–Dom 12h–22h', locations: [{ id: 'loc-p1-1', address: 'Av. Paulista, 1578 — Bela Vista, SP', lat: -23.564, lng: -46.651, isOpen: true }, { id: 'loc-p1-2', address: 'R. Augusta, 2300 — Jardins, SP', lat: -23.558, lng: -46.660, isOpen: true }] },
  { id: 'p9', name: 'iFood Restaurante Parceiro', category: 'restaurante', address: 'Av. Brigadeiro Luís Antônio, 500', distance: '1.5 km', rating: 4.3, acceptedBenefits: ['refeicao','flexivel'], discount: 'Frete grátis', discountExpiresAt: dFuture(30), isOpen: true, lat: -23.576, lng: -46.658, description: 'Culinária contemporânea brasileira.', phone: '(11) 3253-0500', hours: 'Seg–Sex 11h–22h | Sáb–Dom 12h–22h' },
  ...
  { id: 'p15', name: 'Drogasil', category: 'farmacia', address: 'Av. Rebouças, 1150 — Pinheiros, SP', distance: '2.1 km', rating: 4.0, acceptedBenefits: ['saude','flexivel'], discount: '15% em genéricos', discountExpiresAt: dFuture(45), isOpen: true, lat: -23.566, lng: -46.674, description: 'Rede de farmácias com app de descontos e programa de fidelidade.', phone: '(11) 3082-1150', hours: 'Todos os dias 07h–23h', locations: [{ id: 'loc-p15-1', address: 'Av. Rebouças, 1150 — Pinheiros, SP', lat: -23.566, lng: -46.674, isOpen: true }, { id: 'loc-p15-2', address: 'Av. Paulista, 900 — Bela Vista, SP', lat: -23.565, lng: -46.652, isOpen: true }, { id: 'loc-p15-3', address: 'R. Vergueiro, 2000 — Vila Mariana, SP', lat: -23.588, lng: -46.636, isOpen: false }] },
  ...
  // supermercado (2)
  { id: 'p3', name: 'Pão de Açúcar', category: 'supermercado', address: 'Av. Paulista, 2064 — Jardim Paulista, SP', distance: '0.8 km', rating: 4.3, acceptedBenefits: ['alimentacao','flexivel'], discount: '5% em produtos selecionados', discountExpiresAt: dFuture(90), isOpen: true, lat: -23.558, lng: -46.662, description: 'Supermercado premium com hortifruti orgânico e padaria.', phone: '(11) 3064-2064', hours: 'Todos os dias 07h–23h', locations: [{ id: 'loc-p3-1', address: 'Av. Paulista, 2064 — Jardim Paulista, SP', lat: -23.558, lng: -46.662, isOpen: true }, { id: 'loc-p3-2', address: 'Av. Faria Lima, 1500 — Pinheiros, SP', lat: -23.575, lng: -46.685, isOpen: true }] },
  ...
  { id: 'p17', name: 'Posto Shell', category: 'posto', address: 'Av. Rebouças, 600 — Pinheiros, SP', distance: '1.7 km', rating: 4.2, acceptedBenefits: ['transporte','flexivel'], discount: 'R$0,10/litro no app', discountExpiresAt: dFuture(120), isOpen: true, lat: -23.568, lng: -46.672, description: 'Posto com Shell Box e lavagem automotiva.', phone: '(11) 3081-0600', hours: 'Todos os dias 24h' },
